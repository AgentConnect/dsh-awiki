import { a as fencedMailRecoveryObservability, i as failedMailRecoveryObservability, o as successfulMailRecoveryObservability, r as downloadedAttachment, t as AwikiSdkError } from "./sdk-adapter-Ypo58JLm.mjs";
...
async function checkAwikiUpdatePolicy(options) {
	...
	try {
		...
		if (cached !== void 0) return statusFromPolicy(base, cached.policy, cached.checkedAt, true, true);
		return {
			...base,
			offline: true,
			usedCache: false,
...
function statusFromPolicy(base, policy, checkedAt, offline, usedCache) {
	...
	return {
		...
		...modelProxy === void 0 ? {} : { modelProxyTarget: publicTarget(modelProxy) },
		offline,
		usedCache,
...
function decodeServerInfoPolicy(value, origin) {
	...
	if (product.enabled === false) return void 0;
...
function decodePackage(value, expectedName) {
	if (!isRecord(value) || value.name !== expectedName || typeof value.recommended_version !== "string" || typeof value.min_supported_version !== "string" || typeof value.integrity !== "string" || !/^sha512-[A-Za-z0-9+/]+={0,2}$/u.test(value.integrity) || value.repository !== void 0 && typeof value.repository !== "string" || value.requires_plugin !== void 0 && typeof value.requires_plugin !== "string") throw new Error("invalid update package target");
...
function assertVersion(value) {
	if (!/^(?:0|[1-9]\d*)\.(?:0|[1-9]\d*)\.(?:0|[1-9]\d*)(?:-(?:0|[1-9]\d*|[A-Za-z-][0-9A-Za-z-]*)(?:\.(?:0|[1-9]\d*|[A-Za-z-][0-9A-Za-z-]*))*)?(?:\+[0-9A-Za-z-]+(?:\.[0-9A-Za-z-]+)*)?$/u.test(value)) throw new Error("invalid semantic version");
}
		...
		*/
		...
		async switchTenant(tenantId) {
			...
			try {
				...
				await this.discoverTenantCapabilities(3e3);
