import { n as downloadedAttachment } from "./sdk-adapter-BRHQhu3c.mjs";
		...
		*/
		...
		async startDeviceJoinVerification(request) {
			...
			const result = await this.run(async (client) => {
				...
				if (notice.claimedByCurrentDevice) return client.getLocalDeviceJoinVerificationProgress(joinSessionId);
