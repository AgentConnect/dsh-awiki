...
const DEFAULT_AWIKI_SERVICE_URL = "https://awiki.info";
...
const DEFAULT_AWIKI_MESSAGE_SERVICE_DID = "did:wba:awiki.info";
...
function resolveConfig(config) {
	...
	const userServiceUrl = serviceUrl("userServiceUrl", config.userServiceUrl ?? "https://awiki.info", allowInsecureLoopbackForTesting);
	const messageServiceUrl = serviceUrl("messageServiceUrl", config.messageServiceUrl ?? "https://awiki.info", allowInsecureLoopbackForTesting);
	const mailServiceUrl = serviceUrl("mailServiceUrl", config.mailServiceUrl ?? userServiceUrl, allowInsecureLoopbackForTesting);
	const messageServicePublicUrl = serviceUrl("messageServicePublicUrl", config.messageServicePublicUrl ?? "https://awiki.info", allowInsecureLoopbackForTesting);
	const guestGatewayUrl = serviceUrl("guestGatewayUrl", config.guestGatewayUrl ?? "https://awiki.info", allowInsecureLoopbackForTesting);
	return {
		userServiceUrl,
		userServiceDomain: serviceDomain(config.userServiceDomain ?? "awiki.info"),
		messageServiceUrl,
		mailServiceUrl,
		messageServicePublicUrl,
		messageServiceDid: serviceDid(config.messageServiceDid ?? "did:wba:awiki.info"),
		guestGatewayUrl,
