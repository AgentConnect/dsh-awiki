...
const _awiki_dsh_plugin_awiki_clearLocalData_result$schema = z.union([z.object({
  ...
  'error': z.object({
  'code': z.union([z.literal("not-registered"), z.literal("signed-out"), z.literal("already-registered"), z.literal("invalid-request"), z.literal("invalid-otp"), z.literal("challenge-expired"), z.literal("handle-unavailable"), z.literal("not-found"), z.literal("forbidden"), z.literal("conflict"), z.literal("rate-limited"), z.literal("agent-group-unsupported"), z.literal("attachment-too-large"), z.literal("summary-unavailable"), z.literal("summary-timeout"), z.literal("summary-cancelled"), z.literal("summary-invalid-output"), z.literal("summary-failed"), z.literal("network"), z.literal("remote")]).readonly(),
...
const _awiki_dsh_plugin_awiki_downloadAttachment_parameter_0$schema = z.object({
  ...
  'identityId': z.intersection(z.string(), z.unknown()).readonly().optional(),
})
...
const _awiki_dsh_plugin_awiki_getIdentity_result$schema = z.union([z.object({
  ...
  'identityId': z.intersection(z.string(), z.unknown()).readonly(),
...
const _awiki_dsh_plugin_awiki_listIdentities_result$schema = z.union([z.object({
  'ok': z.literal(false).readonly(),
  'error': z.object({
  'code': z.union([z.literal("not-registered"), z.literal("signed-out"), z.literal("already-registered"), z.literal("invalid-request"), z.literal("invalid-otp"), z.literal("challenge-expired"), z.literal("handle-unavailable"), z.literal("not-found"), z.literal("forbidden"), z.literal("conflict"), z.literal("rate-limited"), z.literal("agent-group-unsupported"), z.literal("attachment-too-large"), z.literal("summary-unavailable"), z.literal("summary-timeout"), z.literal("summary-cancelled"), z.literal("summary-invalid-output"), z.literal("summary-failed"), z.literal("network"), z.literal("remote")]).readonly(),
  'message': z.string().readonly(),
  ...
  'value': z.object({
  'items': z.array(z.object({
  'tabId': z.string().readonly(),
  'bindingId': z.intersection(z.string(), z.unknown()).readonly().optional(),
  'identity': z.object({
  'identityId': z.intersection(z.string(), z.unknown()).readonly(),
  'handle': z.intersection(z.string(), z.unknown()).readonly(),
  'did': z.intersection(z.string(), z.unknown()).readonly(),
  ...
  'status': z.union([z.literal("ready"), z.literal("unbound"), z.literal("broken")]).readonly(),
})).readonly(),
}).readonly(),
})])
  ...
  invocations: [
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":1100,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":921,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":587,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":748,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":602,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":757,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":640,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":735,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":608,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":673,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":651,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":867,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":705,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":725,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":895,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":695,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":880,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":770,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/awiki/awiki/src/index.ts","line":715,"column":3},
    },
  ],
  model: {
    "services": [
      {
        ...
        "members": [
          ...
          },
          {
            "kind": "method",
            "name": "listIdentities",
            "signature": "@Remote listIdentities(): Promise<AwikiResult<AwikiIdentityList>>",
            "summary": "List main, bound, and locally recoverable unbound identities.",
            "jsDoc": "/** List main, bound, and locally recoverable unbound identities. */"
          },
          {
            "kind": "method",
            "name": "getSession",
          ...
          },
          {
            ...
            "signature": "@Remote getLocalHistory(request: AwikiHistoryRequest): Promise<AwikiResult<AwikiPage<AwikiMessage>>>",
            "summary": "Read one committed local conversation page without sync, history, or Directory RPC.",
            "jsDoc": "/** Read one committed local conversation page without sync, history, or Directory RPC. */"
          },
          {
            "kind": "method",
          ...
          {
            "kind": "method",
            "name": "getIdentityForAgent",
            "signature": "async getIdentityForAgent(agent: Agent): Promise<AwikiResult<{ readonly identity: AwikiIdentity readonly source: 'main' | 'binding' readonly bindingId?: AwikiBindingId }>>",
            "summary": "Return the effective identity selected for one live DSH Agent.",
            "jsDoc": "/** Return the effective identity selected for one live DSH Agent. */"
          },
          {
            "kind": "method",
            "name": "listAgentIdentityBindings",
            "signature": "listAgentIdentityBindings(): Promise<AwikiResult<readonly AwikiAgentIdentityBinding[]>>",
            "summary": "List public Agent identity bindings for model tools.",
            "jsDoc": "/** List public Agent identity bindings for model tools. */"
          },
          {
            "kind": "method",
            "name": "createAgentIdentity",
            "signature": "async createAgentIdentity( caller: Agent, request: AwikiAgentIdentityCreateRequest, ): Promise<AwikiResult<AwikiAgentIdentityBinding>>",
            "summary": "Provision one approved Agent identity and commit its Host route.",
            "jsDoc": "/** Provision one approved Agent identity and commit its Host route. */"
          },
          {
            "kind": "method",
            "name": "attachAgentIdentity",
            "signature": "async attachAgentIdentity( caller: Agent, request: AwikiAgentIdentityAttachRequest, ): Promise<AwikiResult<AwikiAgentIdentityBinding>>",
            "summary": "Attach or rebind an existing binding/local identity to an approved route.",
            "jsDoc": "/** Attach or rebind an existing binding/local identity to an approved route. */"
          },
          {
            "kind": "method",
            "name": "listConversationsForAgent",
            "signature": "listConversationsForAgent( agent: Agent, request?: AwikiPageRequest, ): Promise<AwikiResult<AwikiPage<AwikiConversation>>>"
          },
          {
            "kind": "method",
            "name": "getHistoryForAgent",
            "signature": "getHistoryForAgent( agent: Agent, request: AwikiHistoryRequest, ): Promise<AwikiResult<AwikiPage<AwikiMessage>>>"
          },
          {
            "kind": "method",
            "name": "sendTextForAgent",
            "signature": "sendTextForAgent(agent: Agent, request: AwikiSendTextRequest): Promise<AwikiResult<AwikiMessage>>"
          },
          {
            "kind": "method",
            "name": "sendAttachmentForAgent",
            "signature": "sendAttachmentForAgent( agent: Agent, request: AwikiSendAttachmentRequest, ): Promise<AwikiResult<AwikiMessage>>"
          },
          {
            "kind": "method",
            "name": "clearLocalData",
        ...
        "types": [
          {
            "name": "AwikiAgentBindingScope",
            "declaration": "export type AwikiAgentBindingScope = 'preset' | 'session';"
          },
          {
            "name": "AwikiAgentIdentityAttachRequest",
            "declaration": "export interface AwikiAgentIdentityAttachRequest {\n    readonly bindingId?: AwikiBindingId;\n    readonly identityId?: AwikiIdentityId;\n    readonly displayName?: string;\n    readonly scope: AwikiAgentBindingScope;\n    readonly targetAgentId?: string;\n    readonly replace?: boolean;\n}"
          },
          {
            "name": "AwikiAgentIdentityBinding",
            "declaration": "export interface AwikiAgentIdentityBinding {\n    readonly bindingId: AwikiBindingId;\n    readonly displayName: string;\n    readonly status: 'creating' | 'ready' | 'failed' | 'broken';\n    readonly identity?: AwikiIdentity;\n    readonly presetRoutes: readonly string[];\n    readonly sessionRouteCount: number;\n    readonly createdAt: number;\n}"
          },
          {
            "name": "AwikiAgentIdentityCreateRequest",
            "declaration": "export interface AwikiAgentIdentityCreateRequest {\n    readonly displayName: string;\n    readonly scope: AwikiAgentBindingScope;\n    readonly targetAgentId?: string;\n}"
          },
          {
          ...
          {
            "name": "AwikiBindingId",
            "declaration": "export type AwikiBindingId = Branded<'AwikiBindingId'>;"
          },
          {
          ...
          },
          {
            ...
            "declaration": "export interface AwikiDownloadAttachmentRequest extends AwikiIdentityScope {\n    readonly attachmentId: AwikiAttachmentId;\n    readonly messageId: AwikiMessageId;\n}"
          },
          {
          ...
          {
            "name": "AwikiIdentityId",
            "declaration": "export type AwikiIdentityId = Branded<'AwikiIdentityId'>;"
          },
          {
            "name": "AwikiIdentityList",
            "declaration": "export interface AwikiIdentityList {\n    readonly items: readonly AwikiIdentityTab[];\n}"
          },
          {
            "name": "AwikiIdentityScope",
            "declaration": "export interface AwikiIdentityScope {\n    readonly identityId?: AwikiIdentityId;\n}"
          },
          {
            "name": "AwikiIdentityTab",
            "declaration": "export interface AwikiIdentityTab {\n    readonly tabId: AwikiIdentityTabId;\n    readonly bindingId?: AwikiBindingId;\n    readonly identity: AwikiIdentity;\n    readonly displayName: string;\n    readonly status: 'ready' | 'unbound' | 'broken';\n}"
          },
          {
            "name": "AwikiIdentityTabId",
            "declaration": "export type AwikiIdentityTabId = string;"
          },
          {
          ...
          },
          {
            ...
            "declaration": "export interface AwikiMarkConversationReadRequest extends AwikiIdentityScope {\n    readonly conversationId: AwikiConversationId;\n}"
          },
          {
            "name": "AwikiMessage",
          ...
          },
          {
            ...
            "declaration": "export interface AwikiPageRequest extends AwikiIdentityScope {\n    readonly cursor?: AwikiCursor;\n    readonly limit?: number;\n}"
          },
          {
          ...
          },
          {
            ...
            "declaration": "export interface AwikiResolvePeerRequest extends AwikiIdentityScope {\n    readonly peer: string;\n}"
          },
          {
            "name": "AwikiResult",
          ...
          {
            "name": "AwikiSdkIdentityClient",
            "declaration": "export interface AwikiSdkIdentityClient {\n    getIdentity(): Promise<AwikiIdentity>;\n    updateDisplayName(request: AwikiUpdateDisplayNameRequest): Promise<AwikiIdentity>;\n    resolvePeer(peer: string): Promise<AwikiResolvedPeer>;\n    listConversations(request?: AwikiPageRequest): Promise<AwikiPage<AwikiConversation>>;\n    getHistory(request: AwikiHistoryRequest): Promise<AwikiPage<AwikiMessage>>;\n    getLocalHistory(request: AwikiHistoryRequest): Promise<AwikiPage<AwikiMessage>>;\n    markConversationRead(conversationId: AwikiConversationId): Promise<number>;\n    sendText(request: AwikiSendTextRequest): Promise<AwikiMessage>;\n    sendAttachment(request: AwikiSdkSendAttachmentRequest): Promise<AwikiMessage>;\n    downloadAttachment(request: { readonly attachmentId: AwikiAttachmentId; readonly messageId: AwikiMessageId; }): Promise<AwikiSdkDownloadedAttachment>;\n}"
          },
          {
          ...
          },
          {
            ...
            "declaration": "export interface AwikiSendAttachmentRequest extends AwikiIdentityScope {\n    readonly target: AwikiMessageTarget;\n    readonly fileName: string;\n    readonly mimeType: string;\n    readonly bytesBase64: string;\n    readonly caption?: string;\n    readonly idempotencyKey: string;\n}"
          },
          {
            "name": "AwikiSendTextRequest",
            "declaration": "export interface AwikiSendTextRequest extends AwikiIdentityScope {\n    readonly target: AwikiMessageTarget;\n    readonly text: string;\n    readonly idempotencyKey: string;\n}"
          },
          {
            "name": "AwikiSession",
          ...
          },
          {
            ...
            "declaration": "export interface AwikiSummarizeConversationRequest extends AwikiIdentityScope {\n    readonly conversationId: AwikiConversationId;\n    readonly unreadCountAtOpen?: number;\n}"
          },
          {
          ...
          },
          {
            ...
            "declaration": "export interface AwikiUpdateDisplayNameRequest extends AwikiIdentityScope {\n    readonly displayName: string;\n}"
          }
        ]
      }
    ],
