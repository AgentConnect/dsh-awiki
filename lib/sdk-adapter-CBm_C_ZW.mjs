...
var RustSdkAdapter = class {
	client;
	scopedClients = /* @__PURE__ */ new Map();
	...
	conversation(value, ownerKey = "default") {
		...
		if (value.lastMessage !== void 0) this.message(value.lastMessage, ownerKey);
		switch (value.kind) {
			case "direct": return {
				kind: "direct",
				...common,
	...
	async forIdentity(identityId) {
		...
		return {
			...
			listConversations: (request) => this.runScoped(identityId, async (client) => page(await client.listConversations(request === void 0 ? void 0 : {
	...
	listConversations(request) {
		return this.run(async (client) => page(await client.listConversations(request === void 0 ? void 0 : {
			...request.cursor === void 0 ? {} : { cursor: String(request.cursor) },
			...request.limit === void 0 ? {} : { limit: request.limit }
...
//#endregion
export { RustSdkAdapter as n, downloadedAttachment as r, AwikiSdkError as t };
