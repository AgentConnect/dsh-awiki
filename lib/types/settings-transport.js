import { AWIKI_SETTINGS_RPC_CHANNEL, AWIKI_SETTINGS_RPC_ENDPOINTS } from "./settings-rpc-contract.js";
/** Register exact buffered routes; Connection applies authentication before dispatch. */
export function registerAwikiSettingsTransport(connection, handler) {
...
export function registerAwikiLoopbackRpc(connection, channel, endpoints, handler) {
