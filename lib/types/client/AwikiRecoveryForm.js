...
export function AwikiRecoveryForm(props) {
    ...
    if (props.operationId === null) {
        return (_jsx(AwikiIdentityPage, { ...props.onExit === undefined ? {} : { onBack: props.onExit }, backLabel: props.onExitLabel ?? '返回本机身份', backDisabled: props.pending, children: _jsxs("form", { className: css.recoveryForm, onSubmit: (event) => { event.preventDefault(); void requestOtp(); }, children: [_jsx("div", { className: css.registrationIcon, children: _jsx(IconUserOutline16, { size: 24 }) }), _jsx("h3", { children: "\u6062\u590D\u5DF2\u6709\u8EAB\u4EFD" }), _jsx("p", { children: "\u8F93\u5165\u539F\u6765\u7684\u5B8C\u6574 Handle \u548C\u7ED1\u5B9A\u624B\u673A\u53F7\uFF0C\u6211\u4EEC\u4F1A\u53D1\u9001\u9A8C\u8BC1\u7801\u6765\u786E\u8BA4\u8EAB\u4EFD\u5F52\u5C5E\u3002" }), _jsxs("label", { children: ["\u5B8C\u6574 Handle", _jsx("input", { ref: handle, autoComplete: "username", placeholder: "\u4F8B\u5982 alice.awiki.info", autoFocus: true })] }), _jsxs("label", { children: ["\u7ED1\u5B9A\u624B\u673A\u53F7", _jsx("input", { ref: requestPhone, type: "tel", autoComplete: "tel" })] }), _jsx("button", { type: "submit", className: css.primary, disabled: props.pending, children: "\u83B7\u53D6\u6062\u590D\u9A8C\u8BC1\u7801" }), error !== null && _jsx("small", { className: css.inlineError, role: "alert", children: error })] }) }));
    }
