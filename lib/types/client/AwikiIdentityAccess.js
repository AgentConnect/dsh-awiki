...
export function AwikiIdentityAccess(props) {
    ...
    if ((props.access === null && props.accessLoading) || (props.access === null && props.accessError)) {
    ...
    if (props.accessError && props.recoveryOperationId === null) {
    ...
    if (props.recoveryOperationId === null && (props.access?.recoveries.length ?? 0) > 1) {
        return _jsxs(AwikiIdentityPage, { children: [_jsx("h3", { children: "\u7EE7\u7EED\u672C\u673A\u672A\u5B8C\u6210\u7684\u6062\u590D" }), _jsx("p", { children: "\u8BF7\u9009\u62E9\u8981\u7EE7\u7EED\u6062\u590D\u7684\u8EAB\u4EFD\u3002" }), props.access.recoveries.map(value => _jsx("button", { type: "button", className: css.primary, disabled: props.pending, onClick: () => { void props.selectRecovery?.(value.operationId); }, children: value.fullHandle }, value.operationId))] });
    }
    if (props.recoveryOperationId === null && recoveryChoice !== null) {
        return _jsx(Recovery, { ...props, requestError: error, fixedHandle: recoveryChoice, onExit: resetIdentityEntry, ...recoveryFactorContext === null ? {} : { initialFactorContext: recoveryFactorContext } });
    }
