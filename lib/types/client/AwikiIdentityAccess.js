...
export function AwikiIdentityAccess(props) {
    ...
    if (props.recoveryOperationId !== null && !signedOutRecoveryOpen) {
        ...
        return (_jsx(Recovery, { ...props, onExit: onExit, onExitLabel: props.sessionStatus === 'signed-out' ? '返回本机身份' : '返回身份入口', ...recoveryFactorContext === null ? {} : { initialFactorContext: recoveryFactorContext } }));
    }
