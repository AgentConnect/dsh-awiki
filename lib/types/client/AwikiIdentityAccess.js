...
export function AwikiIdentityAccess(props) {
    ...
    useEffect(() => {
        if (joinProgress === null || ['authorized', 'cancelled', 'rejected', 'expired'].includes(joinProgress.phase))
            return;
