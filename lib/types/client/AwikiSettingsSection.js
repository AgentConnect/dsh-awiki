...
export function AwikiSettingsSection(props) {
    ...
    return (_jsxs("section", { className: css.section, children: [_jsxs("div", { className: css.heading, children: [_jsx("h2", { className: css.title, children: props.t('nav') }), _jsx("p", { className: css.intro, children: props.t('intro') })] }), _jsx(AdvancedPanel, { ...props, settings: settings })] }));
}
