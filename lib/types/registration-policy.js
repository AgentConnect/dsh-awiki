...
export function registrationHandleLocalPart(value) {
    let normalized = value.trim().toLowerCase().replace(/^@+/u, '');
    if (normalized.startsWith('wba://'))
        normalized = normalized.slice('wba://'.length);
...
export function shortHandleInviteRequired(value) {
...
//# sourceMappingURL=registration-policy.js.map