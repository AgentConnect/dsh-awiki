...
import { checkInstallation, decodeInstallation } from "./update-installation.js";
...
function upgradeCommand(current, plugin, proxy, identityTarget) {
    ...
    if (current.currentModelProxyVersion !== undefined && proxy?.requires_plugin !== undefined && !satisfies(pluginVersion, proxy.requires_plugin))
        return undefined;
