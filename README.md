...
- New three- and four-character Handles require an invitation code; self-service registration is currently unavailable. Existing short Handles retain the Join/recovery flow.
