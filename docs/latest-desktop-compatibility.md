...
These are local compatibility candidates, not published releases. Unit/build evidence does not substitute for actual desktop loading, persistence after reopening, or a real model request. Backend rollout and live account acceptance remain separate gates.
