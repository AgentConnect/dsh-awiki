...
declare const __DSH_AWIKI_BUILTIN_TENANTS_JSON__: string
...
function definition(value: unknown): AwikiBuiltinTenantDefinition {
...
export const AWIKI_DEFAULT_BUILTIN_TENANT =
  AWIKI_BUILTIN_TENANT_CONFIG.tenants[AWIKI_BUILTIN_TENANT_CONFIG.defaultSlot]
