...
function recipient(
  ...
  selectedSummary: AwikiMailSummary | undefined,
): string {
...
export function AwikiMail(props: AwikiMailProps) {
  ...
  const confirmSend = async () => {
    ...
    if (generation !== detailGeneration.current) { setSending(false); return }
              ...
              <article className={css.messageBody}>
                <div className={css.messageMeta}>
                  ...
                  <dl>
                    ...
                    <div><dt>收件人</dt><dd>{recipient(message.summary, folder, account, selectedSummary)}</dd></div>
