...
export interface AwikiSdkClient {
  ...
  deviceJoinManagementStatus(): Promise<readonly { readonly joinSessionId: string; readonly recipientDeviceId: string; readonly phase: string; readonly attempts: number; readonly failureCode?: string }[]>
