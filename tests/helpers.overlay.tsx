...
export function renderOverlay(options: Parameters<typeof fakeRemote>[0] & { registered?: boolean } = {}) {
  ...
  const props: AwikiOverlayProps = {
    ...
    getIdentityServices: () => controller.getIdentityServices(),
    updateIdentityServices: request => controller.updateIdentityServices(request),
    resumeIdentityServicesUpdate: request => controller.resumeIdentityServicesUpdate(request),
